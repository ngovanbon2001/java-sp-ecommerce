...
import ihanoi.ihanoi_backend.entity.StaffDepartment;
import ihanoi.ihanoi_backend.entity.User;
import ihanoi.ihanoi_backend.exception.BizException;
import ihanoi.ihanoi_backend.mapper.CreationDepartmentMapper;
import ihanoi.ihanoi_backend.mapper.DepartmentMapper;
import ihanoi.ihanoi_backend.mapper.WardMapper;
import ihanoi.ihanoi_backend.repository.*;
import ihanoi.ihanoi_backend.repository.specifications.DepartmentSpecification;
...
public class DepartmentService {
    ...
    private final WardAdministratorRepository wardAdministratorRepository;
    ...
    public DepartmentService(
            ...
            WardAdministratorRepository wardAdministratorRepository
    ) {
        ...
        this.wardAdministratorRepository = wardAdministratorRepository;
    }
    ...
    public DepartmentDto updateDepartment(Long departmentId, UpdatingDepartmentDto updatingDepartmentDto) throws BizException {
        if (!this.authorizationService.isRoot() && !this.authorizationService.isAdmin(departmentId)) {
            throw new AccessDeniedException("Từ chối truy cập.");
        }
